...
pixfmt 0 = 'YUYV' desc = 'YUV 4:2:2 (YUYV)'
  ...
  discrete: 640x400:   1/30 1/25 1/20 1/15 1/10 1/5 
  discrete: 768x480:   1/25 1/20 1/15 1/10 1/5 
  discrete: 800x456:   1/25 1/20 1/15 1/10 1/5 
  discrete: 800x504:   1/25 1/20 1/15 1/10 1/5 
  discrete: 800x600:   1/25 1/20 1/15 1/10 1/5 
  discrete: 864x480:   1/25 1/20 1/15 1/10 1/5 
  discrete: 960x720:   1/15 1/10 1/5 
  discrete: 1280x720:   2/15 1/5 
  discrete: 1280x800:   2/15 1/5 
  discrete: 1600x904:   1/5 
  discrete: 1600x1000:   1/5 
...
pixfmt 1 = 'MJPG' desc = 'MJPEG'
  ...
  discrete: 640x360:   1/30 1/25 1/20 1/15 1/10 1/5 
  discrete: 640x400:   1/30 1/25 1/20 1/15 1/10 1/5 
  discrete: 768x480:   1/30 1/25 1/20 1/15 1/10 1/5 
  discrete: 800x456:   1/30 1/25 1/20 1/15 1/10 1/5 
  discrete: 800x504:   1/30 1/25 1/20 1/15 1/10 1/5 
  ...
  discrete: 1280x800:   1/25 1/20 1/15 1/10 1/5 
  discrete: 1600x904:   1/10 1/5 
  discrete: 1600x1000:   1/10 1/5 
  discrete: 1600x1200:   1/10 1/5 
...
current value of 10094851 is 0
current value of 10094849 is 1
*/
    
    set_control(0x980900,128); // Brightness
    set_control(0x980901,41); // Contrast
    set_control(0x980902,28); // Saturation
    set_control(0x98090c,0); // White Balance Temp Auto
    set_control(0x980913,255); // Gain
    set_control(0x980918,2); // 60Hz
    set_control(0x98091a,0); // White Balance Temp
    set_control(0x98091b,128); // Sharpness
    set_control(0x98091c,0); // Backlight Compensation On
    set_control(0x9a0901,1); // Exposure Auto
    set_control(0x9a0902,1162); // Exposure
    set_control(0x9a0903,0); // Exposure Auto Priority
    set_control(0x0A046D04,115); // Focus
    set_control(0x0A046D72,1); // Bits Per Pixel
