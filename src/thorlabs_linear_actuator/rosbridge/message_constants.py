...
MOT_SET_TSTACTUATORTYPE = 0x04FE
...
MOT_REQ_KCUBETRIGCONFIG = 0x0524
MOT_GET_KCUBETRIGCONFIG = 0x0525
...
MOT_SET_MFF_OPERPARAMS = 0x0510
MOT_REQ_MFF_OPERPARAMS = 0x0511
MOT_GET_MFF_OPERPARAMS = 0x0512
...
KSG_SET_KCUBEMMIPARAMS = 0x07F6
KSG_REQ_KCUBEMMIPARAMS = 0x07F7
KSG_GET_KCUBEMMIPARAMS = 0x07F8
KSG_SET_KCUBETRIGIOCONFIG = 0x07F9
KSG_REQ_KCUBETRIGIOCONFIG = 0x07FA
KSG_GET_KCUBETRIGIOCONFIG = 0x07FB
...
KNA_SET_NTTIALPFILTERCOEFFS = 0x0687
KNA_REQ_NTTIALPFILTERCOEFFS = 0x0688
KNA_GET_NTTIALPFILTERCOEFFS = 0x0689
KNA_SET_KCUBEMMIPARAMS = 0x068A
KNA_REQ_KCUBEMMIPARAMS = 0x068B
KNA_GET_KCUBEMMIPARAMS = 0x068C
KNA_SET_KCUBETRIGIOCONFIG = 0x068D
KNA_REQ_KCUBETRIGIOCONFIG = 0x068E
KNA_GET_KCUBETRIGIOCONFIG = 0x068F
KNA_REQ_XYSCAN = 0x06A0
KNA_GET_XYSCAN = 0x06A1
KNA_STOP_XYSCAN = 0x06A2
...
LA_SET_EEPROMPARAMS = 0x0810
LA_ENABLEOUTPUT = 0x0811
LA_DISABLEOUTPUT = 0x0812
LD_OPENLOOP = 0x0813
LD_CLOSEDLOOP = 0x0814
LD_POTROTATING = 0x0815
LD_MAXCURRENTADJUST = 0x0816
LD_SET_MAXCURRENTDIGPOT = 0x0817
LD_REQ_MAXCURRENTDIGPOT = 0x0818
LD_GET_MAXCURRENTDIGPOT = 0x0819
LD_FINDTIAGAIN = 0x081A
LD_TIAGAINADJUST = 0x081B
LA_REQ_STATUSUPDATE = 0x0820
LA_GET_STATUSUPDATE = 0x0821
LA_ACK_STATUSUPDATE = 0x0822
LD_REQ_STATUSUPDATE = 0x0825
LD_GET_STATUSUPDATE = 0x0826
LD_ACK_STATUSUPDATE = 0x0827
LA_SET_KCUBETRIGIOCONFIG = 0x082A
LA_REQ_KCUBETRIGCONFIG = 0x082B
LA_GET_KCUBETRIGCONFIG = 0x082C
...
QUAD_SET_EEPROMPARAMS = 0x0875

#TEC Control Messages
TEC_SET_PARAMS = 0x0840
TEC_REQ_PARAMS = 0x0841
TEC_GET_PARAMS = 0x0842
TEC_SET_EEPROMPARAMS = 0x0850
TEC_REQ_STATUSUPDATE = 0x0860
TEC_GET_STATUSUPDATE = 0x0861
TEC_ACK_STATUSUPDATE = 0x0862

#TIM and KIM Control Messages
PZMOT_SET_PARAMS = 0x08C0
PZMOT_REQ_PARAMS = 0x08C1
PZMOT_GET_PARAMS = 0x08C2
PZMOT_MOVE_ABSOLUTE = 0x04D8
PZMOT_MOVE_COMPLETED = 0x08D6
PZMOT_MOVE_JOG = 0x08D9
PZMOT_REQ_STATUSUPDATE = 0x08E0
